...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1028, null=True))

    def backwards(self, orm):

        # Changing field 'Article.slug'
        db.alter_column(u'articles_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
    ...
    models = {
        u'articles.article': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '1028', 'null': 'True', 'blank': 'True'}),
