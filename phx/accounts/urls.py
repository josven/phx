...
urlpatterns = patterns('',    
    #url(r'^update/$', 'accounts.views.update_account', name='update_account'),
    ...
    url(r'^list/$', 'accounts.views.list_accounts', name='list_accounts'),
    url(r'^list/json/$', 'accounts.views.list_accounts_json', name='list_accounts_json'),
)